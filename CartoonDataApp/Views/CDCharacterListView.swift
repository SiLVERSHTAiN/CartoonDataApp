...
final class CDCharacterListView: UIView {
    
    private let viewModel = CDCharacterListViewViewModel()
...
extension CDCharacterListView: CDCharacterListViewViewModelDelegate {
